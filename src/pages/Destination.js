...
export default function Destination() {
  ...
  return (
    <div className="min-w-full min-h-screen mobile:bg-destinationMobile tablet:bg-destinationTablet desktop:bg-destinationDesktop bg-no-repeat bg-cover overflow-hidden ">
      ...
      <section className="flex flex-col desktop:flex-row min-h-full mt-10 ">
        <section className="desktop:w-1/2 min-h-full text-white ">
          <div className="flex flex-col desktop:ml-10">
            ...
            >
              <img src={moon} className="w-1/2 mt-20 object-cover " />
            </div>
          </div>
        </section>
        <section className="flex flex-col desktop:w-1/2 min-h-full">
          <div className="flex flex-col justify-center  text-center desktop:text-start w-full h-full  font-bellefair text-white pt-20">
            <ul className="flex justify-center desktop:justify-start text-[16px] gap-10 font-thin text-lightWhite ">
              <li className="hover:text-white hover:cursor-pointer">MOON</li>
              <li className="hover:text-white hover:cursor-pointer">MARS</li>
              <li className="hover:text-white hover:cursor-pointer">EUROPA</li>
              <li className="hover:text-white hover:cursor-pointer">TITAN</li>
            </ul>
            <div
              data-aos="fade-left"
              data-aos-duration="1500"
              data-aos-easing="ease-in"
            >
              <h2 className="text-[100px]">MOON</h2>
              <div className="w-full h-full flex justify-center desktop:justify-start">
                {" "}
                <p className="text-lightWhite  tablet:max-w-lg   desktop:text-start mx-10 desktop:mx-0 ">
            ...
            <div className="flex flex-col tablet:flex-row tablet:justify-center desktop:justify-start mt-7 desktop:mt-4 gap-8 desktop:gap-16 mb-10 desktop:mb-0">
              <div className="flex flex-col">
                ...
                <h4 className="text-white font-thin text-[28px]">384,400KM</h4>
              </div>
              <div className="flex flex-col">
                <h1 className="text-lightWhite text-[14px]">
                  EST. TRAVEL TIME
                </h1>
                <h2 className="text-white font-thin text-[28px]">3 DAYS</h2>
              </div>
            </div>
          </div>
        </section>
